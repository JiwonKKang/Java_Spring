...
public class BasicTxTest {
    ...
    void inner_commit() {
        ...
        log.info("내부 트랜잭션 커밋");
        txManager.commit(inner);// 내부 트랜잭션, 즉 논리적 트랜잭션이 커밋하는 경우엔 신규 트랜잭션이 아니기때문에 커밋을 하지않는다.
        //내부 트랜잭션
        log.info("외부 트랜잭션 커밋");
    ...
    void inner_rollback() {
        ...
        TransactionStatus inner = txManager.getTransaction(new DefaultTransactionDefinition());
        log.info("내부 트랜잭션 롤백");
        txManager.rollback(inner);// 내부 트랜잭션, 즉 논리적 트랜잭션이 커밋하는 경우엔 신규 트랜잭션이 아니기때문에 커밋을 하지않는다.
        //내부 트랜잭션
